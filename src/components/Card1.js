  ...
  useEffect(() => {
    axios
      .get(
        ...
        `http://192.168.29.130:5000/api/vehicles/getVehiclesByCityandCategory/city/${city.length==1 ? usercity.data.city : city}/category/5`
      )
      .then((response) => {
        ...
        <div className="container-fluid">
          ...
          {news.data.length > 1 ? (
                  ...
                  <div className="col-12" key={item.id}>
                    ...
                    >
                      ...
                      <div className="card-body">
                        ...
                        <p className="card-title " ><b>{item.model}</b></p>
                        <span>
            ...
            <div className="text-center error" >
              ...
              <h1 className="textblink text-danger ">SORRY ! No Two Wheelers Are Available In Your {city}</h1>
              </div>
          )}
          </div>
        </div>
