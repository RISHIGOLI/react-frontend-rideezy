...
const DriverOut = ({city}) => {
  ...
  useEffect(() => {
    axios.get(
        ...
        `http://192.168.29.130:5000/api/drivers/getDriversByCityAndCategory/city/${city.length==1?data.city:city}/category/8`)
      .then((response) => {
