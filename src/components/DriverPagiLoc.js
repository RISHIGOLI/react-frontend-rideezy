...
const DriverPagiLoc = ({city}) => {
  ...
  React.useEffect(() => {
    myAxios({
      url: `/api/drivers/getAllDriversByCityAndCategoryWithPagination/city/${city.length==1?data.city:city}/category/4?pageNumber=${pageNo}&pageSize=5&sortBy=id&sortDir=asc`,
    }).then((res) => {
